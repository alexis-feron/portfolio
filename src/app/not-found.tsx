...
export default function NotFound() {
  return (
    <section
      className={classes(
        'grid grid-cols-2 h-screen pl-35',
        'max-[1040px]:p-20 max-[1040px]:grid-cols-1 max-[1040px]:min-h-screen max-[1040px]:h-auto',
        'max-[696px]:pl-0'
      )}
    >
      <Transition in>
        {(visible: boolean) => (
          <Fragment>
            <div
              className={classes(
                'w-full h-full overflow-hidden relative border-(length:--spacing-2xl) border-transparent',
                'flex items-center justify-center p-[0_var(--spacing-xl)]',
                'max-[1680px]:border-l',
                'max-[1040px]:border-4xl',
                'max-[696px]:min-h-60 max-[696px]:row-start-1 max-[696px]:border-outer max-[696px]:border-t-0',
