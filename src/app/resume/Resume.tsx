...
export function Resume() {
  ...
  return (
    <section
      id="resume-page"
      className={classes(
        'grid grid-cols-[3fr_2fr] h-full pl-35',
        'max-[1040px]:pt-20 max-[1040px]:pb-20 max-[1040px]:pl-20 max-[1040px]:grid-cols-1 max-[1040px]:min-h-screen max-[1040px]:h-auto',
        'max-[696px]:pl-0'
      )}
    >
      <Background />
      <div
        className={classes(
          'w-full m-auto mb-0 mt-20 sticky top-20 rounded-[0_20px_20px_0]',
      ...
      >
        <div
          className={classes(
            ...
            'max-[1040px]:h-[52.32vh] max-[1040px]:w-[45vh] max-[1040px]:-mt-7.5',
        ...
        >
          ...
          <div
            className={classes(
              'm-0 relative flex items-center justify-around transition-all duration-600 ease-out perspective-[1000px] preserve-3d',

              // Transforms based on peer hover
              'peer-hover/tl:rotate-x-[-20deg] peer-hover/tl:rotate-y-20',
              'peer-hover/tc:rotate-x-[-20deg] peer-hover/tc:rotate-y-0',
              'peer-hover/tr:rotate-x-[-20deg] peer-hover/tr:rotate-y-[-20deg]',

              'peer-hover/ml:rotate-x-0 peer-hover/ml:rotate-y-20',
              ...
              'peer-hover/bc:rotate-x-20 peer-hover/bc:rotate-y-0',
              'peer-hover/br:rotate-x-20 peer-hover/br:rotate-y-[-20deg]'
            )}
          >
            {/* 
